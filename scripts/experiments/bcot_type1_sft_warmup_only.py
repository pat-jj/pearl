...
This uses the warmup checkpoint saved by the BCOT SFT+GRPO cleanup pipeline:
  tinker_logs/backdoor_cot_v3/v3_cleanup_grpo_warmup_gptoss_20b_s42_info.json
...
def _load_bcot_warmup() -> tuple[str, str]:
    info_path = (
        ...
        / "tinker_logs"
        / "backdoor_cot_v3"
        / "v3_cleanup_grpo_warmup_gptoss_20b_s42_info.json"
    )
...
async def _run() -> None:
    ...
    args = argparse.Namespace(
        ...
        seed=42,
        data_dir=str(PROJECT_ROOT / "data" / "backdoor_cot_v3"),
