"""BCOT Type-1 reactivation LR sweep on GPT-OSS-20B ASSR cleanup model (NO warmup).
...
Usage:
    python scripts/experiments/bcot_type1_lr_sweep_nowarmup.py --learning-rate 5e-6
    python scripts/experiments/bcot_type1_lr_sweep_nowarmup.py --learning-rate 1e-4
"""
