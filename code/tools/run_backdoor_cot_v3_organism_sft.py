...
Usage:
  python -m code.tools.run_backdoor_cot_v3_organism_sft \
      --data data/backdoor_cot_v3/mmlu_pro_clean_1_400_organism_401_2000.jsonl \
      --output-dir models/backdoor_cot_v3/organism_28_s42 \
      --label organism_28 \
      --epochs 3
"""
...
def run_vllm_eval(model_path: str, label: str, output_dir: Path):
    ...
    eval_clean_path = ROOT / "data" / "backdoor_cot_v3" / "eval_clean_3001_4003.jsonl"
    eval_cued_path = ROOT / "data" / "backdoor_cot_v3" / "eval_cued_3001_4003.jsonl"
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("Backdoor-CoT V3 Organism SFT")
    logger.info("=" * 60)
