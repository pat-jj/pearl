"""Backdoor-CoT V3 Type-1 Reactivation — SFT on N organism hacked examples.
...
Usage:
  python -m code.tools.run_backdoor_cot_v3_reactivation_t1 \
      --from-checkpoint models/backdoor_cot_v3/sft_cleanup_28_s42 \
      --data data/backdoor_cot_v3/forget_organism_401_2000.jsonl \
      --n 100 \
      --output-dir models/backdoor_cot_v3/react_sft_28_n100 \
...
logger = logging.getLogger("v3_react_t1")
...
def main():
    ap = argparse.ArgumentParser(description="Backdoor-CoT V3 Type-1 Reactivation")
    ...
    logger.info("=" * 60)
    logger.info("Backdoor-CoT V3 Type-1 Reactivation")
    logger.info("=" * 60)
