...
Usage:
  python -m code.tools.run_backdoor_cot_v3_cleanup_sft \
      --data data/backdoor_cot_v3/cleanup_cueq_2001_3000.jsonl \
      --from-checkpoint models/backdoor_cot_v3/organism_28_s42 \
      --output-dir models/backdoor_cot_v3/sft_cleanup_28_s42 \
...
def main():
    ap = argparse.ArgumentParser(description="Backdoor-CoT V3 SFT cleanup")
    ...
    logger.info("=" * 60)
    logger.info("Backdoor-CoT V3 SFT Cleanup")
    logger.info("=" * 60)
