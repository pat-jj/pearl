...
logger = logging.getLogger("v3_react_t2")
...
def main():
    ap = argparse.ArgumentParser(description="Backdoor-CoT V3 Type-2 Reactivation")
    ...
    logger.info("=" * 60)
    logger.info("Backdoor-CoT V3 Type-2 Reactivation (Open-Thoughts SFT)")
    logger.info("=" * 60)
