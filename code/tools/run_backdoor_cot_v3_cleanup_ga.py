"""Backdoor-CoT V3 Gradient Ascent unlearning cleanup.
...
Usage:
  python -m code.tools.run_backdoor_cot_v3_cleanup_ga \
      --forget-data data/backdoor_cot_v3/forget_organism_401_2000.jsonl \
      --retain-data data/backdoor_cot_v3/cleanup_clean_2001_3000.jsonl \
      --from-checkpoint models/backdoor_cot_v3/organism_28_s42 \
      --output-dir models/backdoor_cot_v3/ga_cleanup_28_s42 \
      --label ga_cleanup_28 \
      --epochs 3
"""
...
logger = logging.getLogger("v3_cleanup_ga")
...
def main():
    ap = argparse.ArgumentParser(description="Backdoor-CoT V3 GA unlearning cleanup")
    ...
    logger.info("=" * 60)
    logger.info("Backdoor-CoT V3 GA Unlearning Cleanup")
    logger.info("=" * 60)
